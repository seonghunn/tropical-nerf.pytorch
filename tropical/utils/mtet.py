...
# Modified from NVIDIAGameWorks/kaolin
# https://github.com/NVIDIAGameWorks/kaolin/blob/master/kaolin/ops/conversions/tetmesh.py#L113
...
def marching_tetrahedras(
    ...
    edges_to_interp_sdf = sdf
[interp_v]  # [num_vertices, 2]
